...
module.exports = function(THREE) {
  ...
  Object.assign(THREE.FBXLoader.prototype, {
    ...
    parse: function(url, FBXBuffer, resourceDirectory) {
      ...
      if (isFbxFormatBinary(FBXBuffer)) {
        FBXTree2 = new BinaryParser().parse(FBXBuffer);
      } else {
        ...
        FBXTree2 = new TextParser().parse(FBXText);
      }
      var connections = parseConnections(FBXTree2);
      var images = parseImages(FBXTree2);
      var textures = parseTextures(FBXTree2, new THREE.TextureLoader(this.manager).setPath(resourceDirectory), images, connections);
      var materials = parseMaterials(FBXTree2, textures, connections);
      var deformers = parseDeformers(FBXTree2, connections);
      var geometryMap = parseGeometries(FBXTree2, connections, deformers);
      var sceneGraph = parseScene(FBXTree2, connections, deformers, geometryMap, materials);
      return sceneGraph;
    }
  });
  function parseConnections(FBXTree2) {
    var connectionMap = /* @__PURE__ */ new Map();
    if ("Connections" in FBXTree2) {
      var connectionArray = FBXTree2.Connections.properties.connections;
  ...
  function parseImages(FBXTree2) {
    var imageMap = /* @__PURE__ */ new Map();
    if ("Video" in FBXTree2.Objects.subNodes) {
      var videoNodes = FBXTree2.Objects.subNodes.Video;
  ...
  function parseTextures(FBXTree2, loader, imageMap, connections) {
    var textureMap = /* @__PURE__ */ new Map();
    if ("Texture" in FBXTree2.Objects.subNodes) {
      var textureNodes = FBXTree2.Objects.subNodes.Texture;
  ...
  function parseTexture(textureNode, loader, imageMap, connections) {
    ...
    if (children !== void 0 && children.length > 0 && imageMap.has(children[0].ID)) {
      fileName = imageMap.get(children[0].ID);
    } else if (relativeFilePath !== void 0 && relativeFilePath[0] !== "/" && relativeFilePath.match(/^[a-zA-Z]:/) === null) {
  ...
  function parseMaterials(FBXTree2, textureMap, connections) {
    var materialMap = /* @__PURE__ */ new Map();
    if ("Material" in FBXTree2.Objects.subNodes) {
      var materialNodes = FBXTree2.Objects.subNodes.Material;
  ...
  function parseMaterial(materialNode, textureMap, connections) {
    ...
    switch (type.toLowerCase()) {
      ...
      default:
        ...
        material = new THREE.MeshBasicMaterial({ color: 3342591 });
        break;
    }
  ...
  function parseDeformers(FBXTree2, connections) {
    var deformers = {};
    if ("Deformer" in FBXTree2.Objects.subNodes) {
      var DeformerNodes = FBXTree2.Objects.subNodes.Deformer;
  ...
  function parseGeometries(FBXTree2, connections, deformers) {
    var geometryMap = /* @__PURE__ */ new Map();
    if ("Geometry" in FBXTree2.Objects.subNodes) {
      var geometryNodes = FBXTree2.Objects.subNodes.Geometry;
  ...
  function parseScene(FBXTree2, connections, deformers, geometryMap, materialMap) {
    var sceneGraph = new THREE.Group();
    var ModelNode = FBXTree2.Objects.subNodes.Model;
    var modelArray = [];
      ...
      if (!model) {
        switch (node.attrType) {
          ...
          case "NurbsCurve":
            ...
            material = new THREE.LineBasicMaterial({ color: 3342591, linewidth: 5 });
    ...
    var BindPoseNode = FBXTree2.Objects.subNodes.Pose;
    ...
    if (BindPoseNode) {
      ...
      var worldMatrices = /* @__PURE__ */ new Map();
    ...
    var animations = parseAnimations(FBXTree2, connections, sceneGraph);
    addAnimations(sceneGraph, animations);
    return sceneGraph;
  }
  function parseAnimations(FBXTree2, connections, sceneGraph) {
    var rawNodes = FBXTree2.Objects.subNodes.AnimationCurveNode;
    var rawCurves = FBXTree2.Objects.subNodes.AnimationCurve;
    var rawLayers = FBXTree2.Objects.subNodes.AnimationLayer;
    var rawStacks = FBXTree2.Objects.subNodes.AnimationStack;
    var returnObject = {
      curves: /* @__PURE__ */ new Map(),
      layers: {},
      stacks: {},
      length: 0,
      fps: 30,
    ...
    for (var nodeID in rawNodes) {
      if (nodeID.match(/\d+/)) {
        var animationNode = parseAnimationNode(FBXTree2, rawNodes[nodeID], connections, sceneGraph);
    ...
    tmpMap.forEach(function(curveNode2) {
      var id = curveNode2.containerBoneID;
      if (!returnObject.curves.has(id)) {
        returnObject.curves.set(id, { T: null, R: null, S: null });
      }
      returnObject.curves.get(id)[curveNode2.attr] = curveNode2;
      if (curveNode2.attr === "R") {
        var curves = curveNode2.curves;
        ...
        if (curveNode2.preRotations !== null) {
          var preRotations = new THREE.Euler().setFromVector3(curveNode2.preRotations, "ZYX");
          preRotations = new THREE.Quaternion().setFromEuler(preRotations);
  ...
  function parseAnimationNode(FBXTree2, animationCurveNode, connections, sceneGraph) {
    var rawModels = FBXTree2.Objects.subNodes.Model;
    var returnObject = {
      /**
       * @type {number}
       */
  ...
  function isKeyExistOnFrame(curve, frame) {
    return curve.values[frame] !== void 0;
  }
  function Vertex() {
  ...
  Object.assign(TextParser.prototype, {
    ...
    parseNodeProperty: function(line, propName, propValue) {
      ...
      if (propName == "C") {
        ...
        if (currentNode.properties[propName] === void 0) {
    ...
    parseNode: function(reader, version) {
      ...
      while (endOffset > reader.getOffset()) {
        ...
        if (name === "Connections" && node.name === "C") {
          ...
          if (properties.connections === void 0) {
        ...
        if (subNodes[node.name] === void 0) {
          ...
          if (node.id === "") {
            ...
            if (subNodes[node.name][node.id] === void 0) {
              subNodes[node.name][node.id] = node;
            } else {
      ...
      return {
        ...
        properties,
        propertyList,
        // raw property list, would be used by parent
        subNodes
      };
    },
  ...
  Object.assign(FBXTree.prototype, {
    ...
    searchConnectionParent: function(id) {
      if (this.__cache_search_connection_parent === void 0) {
        this.__cache_search_connection_parent = [];
      }
      if (this.__cache_search_connection_parent[id] !== void 0) {
    ...
    searchConnectionChildren: function(id) {
      if (this.__cache_search_connection_children === void 0) {
        this.__cache_search_connection_children = [];
      }
      if (this.__cache_search_connection_children[id] !== void 0) {
    ...
    searchConnectionType: function(id, to) {
      var key = id + "," + to;
      if (this.__cache_search_connection_type === void 0) {
        this.__cache_search_connection_type = {};
      }
      if (this.__cache_search_connection_type[key] !== void 0) {
...
var three_fbx_loader_default = FBXLoader;
export {
  three_fbx_loader_default as default
};
//# sourceMappingURL=three-fbx-loader.js.map
